      ...
      <Element name="hero">
        <div className="container">
          <div className="relative z-2 max-w-512 max-lg:max-w-388">
            ...
            <p className="max-w-440 mb-13 body-1 max-md:mb10">
              Editor de video por meio de IA XORA de facil utilização click e se
              surpreenda
            </p>
            <LinkScroll to="features" offset={-100} spy smooth>
              <Button icon="/images/zap.svg">Agora tente isso</Button>
            </LinkScroll>
          </div>
          <div
